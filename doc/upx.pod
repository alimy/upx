...
Try B<upx --best --crp-ms=999999 --nrv2b -o result_2b.exe> and
B<upx --best --crp-ms=999999 --nrv2d -o result_2d.exe>, and keep the smaller
...
compression methods options are B<--nrv2b> and B<--nrv2d>.
...
The PE support in B<UPX> is quite stable now, but definitely there are
